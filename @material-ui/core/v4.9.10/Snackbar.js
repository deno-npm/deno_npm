...
var Snackbar = React.forwardRef(function Snackbar(props, ref) {
  ...
  var vertical = _props$anchorOrigin.vertical,
    ...
    autoHideDuration = _props$autoHideDurati === void 0
      ? null
      : _props$autoHideDurati,
    ...
    disableWindowBlurListener = _props$disableWindowB === void 0
      ? false
      : _props$disableWindowB,
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    }, ClickAwayListenerProps), /*#__PURE__*/
    React.createElement(
      "div",
      _extends({
        className: clsx(
          classes.root,
          classes[
            "anchorOrigin".concat(capitalize(vertical)).concat(
