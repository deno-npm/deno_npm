...
import { deepmerge } from "https://cdn.skypack.dev/@material-ui/utils@4.10.2";
...
import { darken, getContrastRatio, lighten } from "./colorManipulator.js";
export var light = {
...
export default function createPalette(palette) {
  ...
  function getContrastText(background) {
    ...
    if (contrast < 3) {
      console.error(
        [
          "Material-UI: the contrast ratio of ".concat(contrast, ":1 for ")
            .concat(contrastText, " on ").concat(background),
  ...
  var augmentColor = function augmentColor(color) {
    var mainShade = arguments.length > 1 && arguments[1] !== undefined
      ? arguments[1]
      : 500;
    var lightShade = arguments.length > 2 && arguments[2] !== undefined
      ? arguments[2]
      : 300;
    var darkShade = arguments.length > 3 && arguments[3] !== undefined
      ? arguments[3]
      : 700;
