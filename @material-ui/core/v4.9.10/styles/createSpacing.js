import { createUnarySpacing } from "https://cdn.skypack.dev/@material-ui/system@v4.9.14";
var warnOnce;
export default function createSpacing() {
  var spacingInput = arguments.length > 0 && arguments[0] !== undefined
    ? arguments[0]
    : 8;
  ...
  var spacing = function spacing() {
    ...
    if (!(args.length <= 4)) {
      console.error(
        "Material-UI: Too many arguments provided, expected between 0 and 4, got "
          .concat(args.length),
      );
    }
