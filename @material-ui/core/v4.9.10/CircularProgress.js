...
var CircularProgress = React.forwardRef(function CircularProgress(props, ref) {
  var classes = props.classes,
    ...
    disableShrink = _props$disableShrink === void 0
      ? false
      : _props$disableShrink,
  ...
  if (variant === "determinate" || variant === "static") {
    ...
    if (variant === "static") {
      ...
      circleStyle.strokeDashoffset = "".concat(
        (easeIn((100 - value) / 100) * circumference).toFixed(3),
        "px",
      );
      rootStyle.transform = "rotate(".concat(
        (easeOut(value / 70) * 270).toFixed(3),
        "deg)",
      );
    }
  }
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    React.createElement(
      "svg",
      {
        ...
        viewBox: "".concat(SIZE / 2, " ").concat(SIZE / 2, " ").concat(
          SIZE,
          " ",
        ).concat(SIZE),
      }, /*#__PURE__*/
...
CircularProgress.propTypes = {
  ...
  disableShrink: chainPropTypes(PropTypes.bool, function (props) {
    if (
      props.disableShrink && props.variant && props.variant !== "indeterminate"
    ) {
      return new Error(
