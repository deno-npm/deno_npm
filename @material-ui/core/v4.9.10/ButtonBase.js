...
import TouchRipple from "./ButtonBase/TouchRipple.js";
export var styles = {
...
var ButtonBase = React.forwardRef(function ButtonBase(props, ref) {
  var action = props.action,
    ...
    disableRipple = _props$disableRipple === void 0
      ? false
      : _props$disableRipple,
    _props$disableTouchRi = props.disableTouchRipple,
    disableTouchRipple = _props$disableTouchRi === void 0
      ? false
  ...
  function useRippleHandler(rippleAction, eventCallback) {
    var skipRippleAction = arguments.length > 2 && arguments[2] !== undefined
      ? arguments[2]
      : disableTouchRipple;
  ...
  var handleKeyDown = useEventCallback(function (event) {
    ...
    if (
      focusRipple && !keydownRef.current && focusVisible && rippleRef.current &&
      event.key === " "
    ) {
  ...
  var handleKeyUp = useEventCallback(function (event) {
    ...
    if (
      focusRipple && event.key === " " && rippleRef.current && focusVisible &&
    ...
    if (
      onClick && event.target === event.currentTarget && isNonNativeButton() &&
