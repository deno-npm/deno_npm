...
var TextareaAutosize = React.forwardRef(function TextareaAutosize(props, ref) {
  var onChange = props.onChange,
    ...
    other = _objectWithoutProperties(
      props,
      ["onChange", "rows", "rowsMax", "rowsMin", "style", "value"],
    );
  ...
  var syncHeight = React.useCallback(function () {
    ...
    var padding = getStyleValue(computedStyle, "padding-bottom") +
      getStyleValue(computedStyle, "padding-top");
    var border = getStyleValue(computedStyle, "border-bottom-width") +
    ...
    var outerHeightStyle = outerHeight +
...
TextareaAutosize.propTypes = {
  ...
  value: PropTypes.oneOfType(
    [PropTypes.arrayOf(PropTypes.string), PropTypes.number, PropTypes.string],
  ),
};
