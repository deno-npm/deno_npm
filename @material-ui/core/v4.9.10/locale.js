    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref) {
        var from = _ref.from,
          to = _ref.to,
          count = _ref.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " d\u0259n ")
          .concat(count);
      },
...
export var bgBG = {
  props: {
    ...
    MuiRating: {
      getLabelText: function getLabelText(value) {
        return "".concat(value, " \u0417\u0432\u0435\u0437\u0434").concat(
          value !== 1 ? "и" : "а",
        );
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref3) {
        var from = _ref3.from,
          to = _ref3.to,
          count = _ref3.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " de ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref4) {
        var from = _ref4.from,
          to = _ref4.to,
          count = _ref4.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " z ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref5) {
        var from = _ref5.from,
          to = _ref5.to,
          count = _ref5.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " von ")
          .concat(count);
      },
  ...
  props: {
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref7) {
        var from = _ref7.from,
          to = _ref7.to,
          count = _ref7.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " / ")
          .concat(count);
      },
    ...
    MuiPagination: {
      ...
      getItemAriaLabel: function getItemAriaLabel(type, page, selected) {
        if (type === "page") {
          return "".concat(selected ? "" : "Vali ", "lehek\xFClg ").concat(
            page,
          );
        }
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref10) {
        var from = _ref10.from,
          to = _ref10.to,
          count = _ref10.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " sur ")
          .concat(count);
      },
...
export var heIL = {
  props: {
    ...
    MuiRating: {
      getLabelText: function getLabelText(value) {
        return "".concat(value, " \u05DB\u05D5\u05DB\u05D1").concat(
          value !== 1 ? "ים" : "",
        );
      },
      emptyLabelText: "ריק",
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref14) {
        var from = _ref14.from,
          to = _ref14.to,
          count = _ref14.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " dari ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref15) {
        var from = _ref15.from,
          to = _ref15.to,
          count = _ref15.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " af ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref16) {
        var from = _ref16.from,
          to = _ref16.to,
          count = _ref16.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " di ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref17) {
        var from = _ref17.from,
          to = _ref17.to,
          count = _ref17.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " of ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref19) {
        var from = _ref19.from,
          to = _ref19.to,
          count = _ref19.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " van ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref23) {
        var from = _ref23.from,
          to = _ref23.to,
          count = _ref23.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " din ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref26) {
        var from = _ref26.from,
          to = _ref26.to,
          count = _ref26.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " av ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref27) {
        var from = _ref27.from,
          to = _ref27.to,
          count = _ref27.count;
        return "".concat(count, " tanesinden ").concat(from, "-").concat(
          to === -1 ? count : to,
        );
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref28) {
        var from = _ref28.from,
          to = _ref28.to,
          count = _ref28.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " \u0437 ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref29) {
        var from = _ref29.from,
          to = _ref29.to,
          count = _ref29.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " trong ")
          .concat(count);
      },
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: function labelDisplayedRows(_ref30) {
        var from = _ref30.from,
          to = _ref30.to,
          count = _ref30.count;
        return "".concat(from, "-").concat(to === -1 ? count : to, " \u7684 ")
          .concat(count);
      },
