...
import { TransitionGroup } from "https://cdn.skypack.dev/react-transition-group@v4.4.1";
...
export var styles = function styles(theme) {
  return {
    ...
    rippleVisible: {
      opacity: 0.3,
      transform: "scale(1)",
      animation: "$enter ".concat(DURATION, "ms ").concat(
    ...
    childLeaving: {
      opacity: 0,
      animation: "$exit ".concat(DURATION, "ms ").concat(
        theme.transitions.easing.easeInOut,
      ),
    },
...
var TouchRipple = React.forwardRef(function TouchRipple(props, ref) {
  ...
  var start = React.useCallback(function () {
    ...
    var _options$pulsate = options.pulsate,
      ...
      fakeElement = _options$fakeElement === void 0
        ? false
    ...
    if (
      center || event.clientX === 0 && event.clientY === 0 ||
