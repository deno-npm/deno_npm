...
var Popover = React.forwardRef(function Popover(props, ref) {
  var action = props.action,
    ...
    anchorReference = _props$anchorReferenc === void 0
      ? "anchorEl"
      : _props$anchorReferenc,
    ...
    marginThreshold = _props$marginThreshol === void 0
      ? 16
      : _props$marginThreshol,
    ...
    TransitionComponent = _props$TransitionComp === void 0 ? Grow
    : _props$TransitionComp,
    _props$transitionDura = props.transitionDuration,
    transitionDurationProp = _props$transitionDura === void 0 ? "auto"
    : _props$transitionDura,
    _props$TransitionProp = props.TransitionProps,
    TransitionProps = _props$TransitionProp === void 0 ? {}
  ...
  var getAnchorOffset = React.useCallback(
    function (contentAnchorOffset) {
      ...
      var anchorElement = resolvedAnchorEl instanceof containerWindow.Element
        ? resolvedAnchorEl
      ...
      if (
        process.env.NODE_ENV !== "test" && box.top === 0 && box.left === 0 &&
      ...
      var anchorVertical = contentAnchorOffset === 0
  ...
  var getContentAnchorOffset = React.useCallback(function (element) {
    ...
    if (getContentAnchorEl && anchorReference === "anchorEl") {
      ...
      if (contentAnchorEl && element.contains(contentAnchorEl)) {
        ...
        contentAnchorOffset =
          contentAnchorEl.offsetTop + contentAnchorEl.clientHeight / 2 -
            scrollTop || 0;
      } // != the default value
  ...
  var getTransformOrigin = React.useCallback(function (elemRect) {
    var contentAnchorOffset = arguments.length > 1 && arguments[1] !== undefined
      ? arguments[1]
      : 0;
    return {
  ...
  if (
    transitionDurationProp === "auto" && !TransitionComponent.muiSupportAuto
  ) {
    ...
    function (props) {
      if (
        ...
        if (resolvedAnchorEl instanceof containerWindow.Element) {
          ...
          if (
            process.env.NODE_ENV !== "test" && box.top === 0 &&
            box.left === 0 && box.right === 0 && box.bottom === 0
          ) {
            return new Error(
              [
                "Material-UI: the `anchorEl` prop provided to the component is invalid.",
