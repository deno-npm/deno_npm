...
import { darken, lighten } from "./styles/colorManipulator.js";
...
export var styles = function styles(theme) {
  ...
  return {
    ...
    dashedColorPrimary: {
      backgroundImage: "radial-gradient(".concat(backgroundPrimary, " 0%, ")
    ...
    dashedColorSecondary: {
      backgroundImage: "radial-gradient(".concat(backgroundSecondary, " 0%, ")
...
var LinearProgress = React.forwardRef(function LinearProgress(props, ref) {
  var classes = props.classes,
    ...
    other = _objectWithoutProperties(
      props,
      ["classes", "className", "color", "value", "valueBuffer", "variant"],
    );
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    variant === "buffer"
      ? /*#__PURE__*/ React.createElement("div", {
        className: clsx(
          classes.dashed,
          classes["dashedColor".concat(capitalize(color))],
        ),
      })
      : null, /*#__PURE__*/
