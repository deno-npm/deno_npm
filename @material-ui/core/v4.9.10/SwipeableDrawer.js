...
import { elementTypeAcceptingRef } from "https://cdn.skypack.dev/@material-ui/utils@4.10.2";
import styles from "https://dev.jspm.io/@material-ui/styles@4.9.10";
import Drawer, { getAnchor, isHorizontal } from "./Drawer.js";
import ownerDocument from "./utils/ownerDocument.js";
import useEventCallback from "./utils/useEventCallback.js";
import { duration } from "./styles/transitions.js";
import useTheme from "./styles/useTheme.js";
import { getTransitionProps } from "./transitions/utils.js";
import NoSsr from "./NoSsr.js";
import SwipeArea from "./SwipeableDrawer/SwipeArea.js"; // This value is closed to what browsers are using internally to
...
var disableSwipeToOpenDefault = typeof navigator !== "undefined" &&
...
var SwipeableDrawer = React.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  var _props$anchor = props.anchor,
    ...
    disableBackdropTransition = _props$disableBackdro === void 0
      ? false
      : _props$disableBackdro,
    _props$disableDiscove = props.disableDiscovery,
    disableDiscovery = _props$disableDiscove === void 0
      ? false
      : _props$disableDiscove,
    _props$disableSwipeTo = props.disableSwipeToOpen,
    disableSwipeToOpen = _props$disableSwipeTo === void 0
      ? disableSwipeToOpenDefault
      : _props$disableSwipeTo,
    hideBackdrop = props.hideBackdrop,
    _props$hysteresis = props.hysteresis,
    hysteresis = _props$hysteresis === void 0 ? 0.52 : _props$hysteresis,
    _props$minFlingVeloci = props.minFlingVelocity,
    minFlingVelocity = _props$minFlingVeloci === void 0 ? 450
    : _props$minFlingVeloci,
    _props$ModalProps = props.ModalProps;
  _props$ModalProps = _props$ModalProps === void 0 ? {} : _props$ModalProps;

  var BackdropProps = _props$ModalProps.BackdropProps,
    ModalPropsProp = _objectWithoutProperties(
      _props$ModalProps,
      ["BackdropProps"],
    ),
    ...
    swipeAreaWidth = _props$swipeAreaWidth === void 0
      ? 20
  ...
  var setPosition = React.useCallback(
    function (translate) {
      ...
      var _options$mode = options.mode,
        ...
        changeTransition = _options$changeTransi === void 0
          ? true
          : _options$changeTransi;
      var anchorRtl = getAnchor(theme, anchor);
      var rtlTranslateMultiplier = ["right", "bottom"].indexOf(anchorRtl) !== -1
        ? 1
        : -1;
      ...
      if (!disableBackdropTransition && !hideBackdrop) {
        ...
        backdropStyle.opacity = 1 -
          translate / getMaxTranslate(horizontalSwipe, paperRef.current);
  ...
  var handleBodyTouchMove = useEventCallback(function (event) {
    ...
    if (
      open && paperRef.current.contains(event.target) &&
      nodeThatClaimedTheSwipe == null
    ) {
    ...
    if (swipeInstance.current.isSwiping == null) {
      ...
      if (
        definitelySwiping === true || (horizontalSwipe
    ...
    var velocity = (translate - swipeInstance.current.lastTranslate) /
      (performance.now() - swipeInstance.current.lastTime) * 1e3; // Low Pass filter.

    swipeInstance.current.velocity = swipeInstance.current.velocity * 0.4 +
      velocity * 0.6;
    swipeInstance.current.lastTranslate = translate;
  ...
  var handleBodyTouchStart = useEventCallback(function (event) {
    ...
    if (
      open && !backdropRef.current.contains(event.target) &&
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    !disableSwipeToOpen && variant === "temporary" && /*#__PURE__*/
      React.createElement(
        NoSsr,
        null, /*#__PURE__*/
        React.createElement(
