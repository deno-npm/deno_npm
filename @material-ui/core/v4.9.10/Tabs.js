...
import {
  ...
  detectScrollType,
} from "./utils/scrollLeft.js";
import animate from "./internal/animate.js";
import ScrollbarSize from "./Tabs/ScrollbarSize.js";
import withStyles from "./styles/withStyles.js";
import TabIndicator from "./Tabs/TabIndicator.js";
import TabScrollButton from "./Tabs/TabScrollButton.js";
...
var Tabs = React.forwardRef(function Tabs(props, ref) {
  var action = props.action,
    ...
    indicatorColor = _props$indicatorColor === void 0
      ? "secondary"
      : _props$indicatorColor,
    ...
    ScrollButtonComponent = _props$ScrollButtonCo === void 0
      ? TabScrollButton
      : _props$ScrollButtonCo,
    _props$scrollButtons = props.scrollButtons,
    scrollButtons = _props$scrollButtons === void 0 ? "auto"
    : _props$scrollButtons,
    _props$TabIndicatorPr = props.TabIndicatorProps,
    TabIndicatorProps = _props$TabIndicatorPr === void 0 ? {}
    : _props$TabIndicatorPr,
    ...
    if (tabMeta && tabsMeta) {
      if (vertical) {
        ...
        var correction = isRtl
          ? tabsMeta.scrollLeftNormalized + tabsMeta.clientWidth -
  ...
  var getConditionalElements = function getConditionalElements() {
    ...
    var showScrollButtons = scrollable &&
      (scrollButtons === "auto" && scrollButtonsActive ||
        scrollButtons === "desktop" || scrollButtons === "on");
    conditionalElements.scrollButtonStart = showScrollButtons
      ? /*#__PURE__*/ React.createElement(ScrollButtonComponent, {
  ...
  var scrollSelectedIntoView = useEventCallback(function () {
    ...
    if (tabMeta[start] < tabsMeta[start]) {
      ...
      var nextScrollStart = tabsMeta[scrollStart] +
        (tabMeta[start] - tabsMeta[start]);
      scroll(nextScrollStart);
    } else if (tabMeta[end] > tabsMeta[end]) {
      // right side of button is out of view
      var _nextScrollStart = tabsMeta[scrollStart] +
  ...
  var updateScrollButtonState = useEventCallback(function () {
    if (scrollable && scrollButtons !== "off") {
      ...
      if (vertical) {
        ...
        var scrollLeft = getNormalizedScrollLeft(
          tabsRef.current,
          theme.direction,
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    conditionalElements.scrollbarSizeListener, /*#__PURE__*/
    React.createElement(
      "div",
      {
        className: clsx(
