...
import _typeof from "https://cdn.skypack.dev/@babel/runtime/helpers/esm/typeof";
...
var SelectInput = React.forwardRef(function SelectInput(props, ref) {
  ...
  React.useEffect(function () {
    if (!foundMatch && !multiple && value !== "") {
      ...
      console.warn(
        [
          "Material-UI: you have provided an out-of-range value `".concat(
            value,
            "` for the select ",
  ...
  var buttonId = SelectDisplayProps.id ||
