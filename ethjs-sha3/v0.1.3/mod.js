...
function sha3(dataInput, toBuffer) {
  ...
  if (typeof (data) === "string") {
    ...
    throw new Error(
      `[ethjs-sha3] data input must be type 'String' or Buffer 'Object' instance got ${typeof dataInput}, if your trying to hash a BigNumber or BN object, convert it to a string by using 'value.toString(10)'.`,
    );
  }
